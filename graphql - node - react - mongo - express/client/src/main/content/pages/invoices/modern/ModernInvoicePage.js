                                ...
                                <div className="flex flex-row justify-between items-start">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <div className="flex items-center mb-80 print:mb-0">
                                            ...
                                            <img className="w-160 print:w-60" src="assets/images/logos/dealmax-logo.png" alt="logo"/>
                                        ...
                                        <div className="flex items-center">
                                            <div className="flex justify-end items-center w-160 print:w-60">
                                                <img className="w-160 print:w-60" src="assets/images/logos/client-logo.png" alt="logo"/>
                                            </div>
